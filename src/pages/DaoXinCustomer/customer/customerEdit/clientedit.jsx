...
import * as SysField from '@/pages/DaoXinCustomer/contacts/contactsField';
import {contactsAdd, contactsDetail, contactsEdit} from '@/pages/DaoXinCustomer/contacts/contactsUrl';
