...
const AccountAsk: React.FC<Props> = (props) => {
  const {visible, onClose, data = {}, visibilityToggle = true} = props;
  ...
  return <>
    <Drawer height='100vh' placement='top' visible={visible} onClose={() => onClose()}>
