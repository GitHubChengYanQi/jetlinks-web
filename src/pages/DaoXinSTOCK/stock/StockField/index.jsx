...
import StockPlaceList from '@/pages/DaoXinSTOCK/stock/StockEdit/components/StockPlaceList';
import PlaceEdit from '@/pages/DaoXinSTOCK/storehouse/StorehouseEdit';
import Items from '@/pages/DaoXinSTOCK/stock/StockEdit/components/Items';
