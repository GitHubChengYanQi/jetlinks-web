...
import {Button, Card, Descriptions, notification, Space, Spin, Tabs} from 'antd';
...
const Detail = ({id}) => {
  ...
  const {loading: excelLoading, run: excel} = useRequest(contractExcel, {
  ...
  return <Spin spinning={excelLoading} wrapperClassName='123'>
