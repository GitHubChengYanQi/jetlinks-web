...
const CrmBusinessDetailedEdit = ({...props}) => {
  ...
  return (
    <Form
      ...
      fieldKey="id"
    >
      <FormItem label="商机" disabled name="businessId" component={SysField.BusinessId} required/>
      <FormItem label="产品" disabled name="itemId" component={SysField.ItemId} required/>
